...
public class PaisesJdbcDAO implements PaisesDAO {
	...
	public List<Pais> getPaises() {  
		 ...
		 return this.jdbcTemplate.query("select pais, capital from pais"
, new PaisMapper());
	}	 
	...
	public void updatePais(Pais pais) {
		this.jdbcTemplate.update(
				"update Pais set capital = ? where nom = ?", pais.getCapital(), pais.getNom());
	}
